...
public class GarbageCodeTransform extends Transform {
    ...
    private boolean isScopeFull;

    public GarbageCodeTransform(boolean isScopeFull) {
        this.isScopeFull = isScopeFull;
    }
    ...
    public Set<? super Scope> getScopes() {
        ...
        return isScopeFull ? TransformManager.SCOPE_FULL_PROJECT : Sets.immutableEnumSet(
                Scope.PROJECT);
